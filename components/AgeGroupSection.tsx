    ...
    <section className="mx-auto max-w-7xl px-6 py-16">
      ...
      <div className="grid grid-cols-2 gap-6 lg:grid-cols-4">
        {ageGroups.map((group, index) => (
          ...
          >
            <div
              className={`mx-auto aspect-square w-full max-w-60 overflow-hidden rounded-full border-4 ${
            ...
            <h3 className="mt-4 font-serif text-2xl text-gray-950">{group.title}</h3>
